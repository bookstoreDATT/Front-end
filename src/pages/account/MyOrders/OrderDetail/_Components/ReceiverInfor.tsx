    ...
    const receiverItems: DescriptionsProps['items'] = [
        {
            ...
            children: <p className='font-medium capitalize'>{receiverInfo?.name}</p>,
        },
        {
            key: 'phone',
            label: <span className='font-semibold capitalize'>Số Điện Thoại:</span>,
            children: <p className='font-medium capitalize'>{receiverInfo?.phone}</p>,
        },
        {
            key: 'email',
            label: <span className='font-semibold capitalize'>Email:</span>,
            children: <p className='font-medium capitalize'>{receiverInfo?.email}</p>,
        },
    ];
    ...
    const shippingAddressItems: DescriptionsProps['items'] = [
        {
            ...
            children: <p>{shippingAddress}</p>,
        },
        {
            key: 'description',
            label: <span className='font-semibold capitalize'>Ghi chú đơn hàng:</span>,
            children: <p className='capitalize'>{description || 'Không có ghi chú'}</p>,
        },
    ];
