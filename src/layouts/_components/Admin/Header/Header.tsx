        ...
        <header className='drop-shadow-1 dark:bg-boxdark sticky top-0 z-999 flex w-full bg-white dark:drop-shadow-none'>
            <div className='shadow-2 flex flex-grow items-center justify-between px-4 py-2 md:px-4 2xl:px-4'>
                ...
                <Link className='block flex-shrink-0' to='/admin'>
                    <span className='text-2xl font-semibold text-blue-500 capitalize'>Bookstore - </span>
                    <span className='text-2xl font-semibold text-blue-500 capitalize'>Quản trị Admin</span>
                </Link>
